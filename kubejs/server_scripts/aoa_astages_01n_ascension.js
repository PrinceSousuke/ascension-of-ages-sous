...
;(function () {
  ...
  var itemLocks = [
    ...
    ["ascension", "avaritia:nether_crafting_table", "block_item"],
    ["ascension", "avaritia:end_crafting_table", "block_item"],
    ["ascension", "avaritia:sculk_crafting_table", "block_item"],
    ["ascension", "avaritia:extreme_crafting_table", "block_item"],
    ["ascension", "avaritia:extreme_smithing_table", "block_item"],
    ["ascension", "avaritia:extreme_anvil", "block_item"],
    ["ascension", "avaritia:tesseract", "block_item"],
    ["ascension", "avaritia:compressed_chest", "block_item"],
    ["ascension", "avaritia:infinity_chest", "block_item"],
    ["ascension", "avaritia:neutron_collector", "block_item"],
    ["ascension", "avaritia:neutron_compressor", "block_item"],
    ["ascension", "avaritia:dense_neutron_collector", "block_item"],
    ["ascension", "avaritia:dense_neutron_compressor", "block_item"],
    ["ascension", "avaritia:denser_neutron_collector", "block_item"],
    ["ascension", "avaritia:denser_neutron_compressor", "block_item"],
    ["ascension", "avaritia:densest_neutron_collector", "block_item"],
    ["ascension", "avaritia:densest_neutron_compressor", "block_item"],
    ["ascension", "avaritia:neutron", "block_item"],
    ["ascension", "avaritia:infinity", "block_item"],
    ["ascension", "avaritia:crystal_matrix", "block_item"],
    ["ascension", "avaritia:blaze_cube_block", "block_item"],
    ["ascension", "avaritia:star_fuel_block", "block_item"],
    ["ascension", "avaritia:diamond_lattice_block", "block_item"],
    ["ascension", "avaritia:neutron_gear", "item"],
    ["ascension", "avaritia:diamond_lattice", "item"],
    ["ascension", "avaritia:endest_pearl", "item"],
    ["ascension", "avaritia:blaze_cube", "item"],
    ["ascension", "avaritia:enhancement_core", "item"],
    ["ascension", "avaritia:infinity_catalyst", "item"],
    ["ascension", "avaritia:eternal_singularity", "item"],
    ["ascension", "avaritia:upgrade_smithing_template", "item"],
