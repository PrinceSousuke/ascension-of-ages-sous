...
(quests, KubeJS, config, docs). It does not ship mod jars, saves, or worlds.

**Repository:** https://github.com/andrewgodowsky-aoa/ascension-of-ages
...
- Documentation (`docs/`, `progression/`)
...
```powershell
git clone https://github.com/andrewgodowsky-aoa/ascension-of-ages.git
cd ascension-of-ages
```

Copy authored folders into your CurseForge codex instance as needed; do not
